...
TOPICS: dict[str, TopicRule] = {
    ...
    "convertible_bond_holder": TopicRule(
        ...
        # 관점(FACET): '취득' 단독 금지(=유형자산 취득 노이즈). 자산분류 신호 또는 밀착구문만 인정.
        facet_required=[[
            "금융자산", "매도가능증권", "단기매매증권", "당기손익인식금융자산",
            "당기손익-공정가치", "기타포괄손익-공정가치", "상각후원가측정금융자산",
            "투자주식", "투자유가증권", "투자자산", "지분증권", "채무증권",
            "전환사채취득", "전환사채를취득", "전환사채를보유", "전환사채매입", "취득한전환사채",
        ]],
